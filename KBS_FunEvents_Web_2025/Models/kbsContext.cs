...
public partial class kbsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BuBuchungsId).HasName("tbl_Buchungen_PK");

            entity.HasOne(d => d.EdEvDaten).WithMany(p => p.TblBuchungens)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tbl_EvDaten_tbl_Buchungen_FK1");

            entity.HasOne(d => d.KdKunden).WithMany(p => p.TblBuchungens)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.EkEvKategorieId).HasName("tbl_EvKategorie_PK");
        });

        modelBuilder.Entity<TblEvVeranstalter>(entity =>
        {
            entity.HasKey(e => e.EvEvVeranstalterId).HasName("tbl_EvVeranstalter_PK");
        });

        modelBuilder.Entity<TblEvent>(entity =>
        {
            entity.HasKey(e => e.EtEventId).HasName("tbl_EvBeschreibung_PK");

            entity.HasOne(d => d.EkEvKategorie).WithMany(p => p.TblEvents)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tbl_EvKategorie_tbl_Events_FK1");

            entity.HasOne(d => d.EvEvVeranstalter).WithMany(p => p.TblEvents)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.EdEvDatenId).HasName("tbl_Events_PK");

            entity.HasOne(d => d.EtEvent).WithMany(p => p.TblEventDatens)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.KdKundenId).HasName("tbl_Kunden_PK");
        });
